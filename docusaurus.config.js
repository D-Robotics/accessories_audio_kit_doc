...
const resolvedBaseUrl =
  process.env.DOCS_BASE_URL?.trim() || (isDev ? "/" : "/accessories_audio_kit_doc/");
...
const config = {
  ...
  baseUrl: "/accessories_audio_kit_doc/",
  customFields: {
    docBuildScope:
  ...
  projectName: "accessories_audio-kit_doc", // Usually your repo name.
  ...
  scripts: [
    ...
    {
      src: `/accessories_audio_kit_doc${localePrefix}/js/umami-events.js`,
      defer: true,
    },
  ...
  themeConfig:
    ...
    tableOfContents: {
      ...
      algolia: {
        ...
        indexName: "accessories_audio_kit_doc",
